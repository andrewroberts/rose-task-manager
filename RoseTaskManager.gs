...
function onEmailStatusUpdates(arg)   {return RTM.onEmailStatusUpdates(arg)}
function onFormSubmit(arg)           {return RTM.onFormSubmit(arg)}
function onEdit(arg)                 {return RTM.onEdit(arg)}
function onCalendarTrigger(arg)      {return RTM.onCalendarTrigger(arg)}
