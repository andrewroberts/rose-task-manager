...
It is still early in development and at present only supports planned preventative maintenance (PPM, regular tasks) and work orders (ad hoc job or task requests): a collaborative/team task manager. 
